...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        form.unixuser.data = current_user.unixuser
        form.unixid.data = current_user.unixid
...
# curl -i http://localhost:5000/todo/api/v1.0/test
# curl -u maxkv333:qq112233 -i http://localhost:5000/todo/api/v1.0/tests
